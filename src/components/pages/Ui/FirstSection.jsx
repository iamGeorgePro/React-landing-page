...
function FirstSection() {
  ...
  return (
   <section className='container mt-[132px] mb-[150px]'>
    ...
    <input className='bg-[#9CB9CE] px-[25px] placeholder:text-black text-[20px] text-black font-normal rounded-[44px] w-[300px]  md:w-[500px]  lg:w-[684px] h-[64px] outline-none border-none' name="user_email" placeholder='Email Address' />
    ...
    <div className='mt-[100px] container'>
        <div className='block md:flex  gap-10 lg:gap-20 items-center justify-center mb-10'>
            <div className='bg-[#D4DFE7] h-full w-full md:w-[340px] md:h-[375.5px] lg:h-[383.51px] lg:w-[353px] text-center pb-10 rounded-[11px]'>
            ...
            <div className='bg-[#EBB40A26] rounded-[11px]  h-full w-full md:w-[340px] md:h-[375.5px] lg:h-[383.51px] lg:w-[353px] text-center pb-10 md:mt-0 mt-10'>
