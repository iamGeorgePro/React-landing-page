...
function FirstSection() {
  return (
   <section className='container mt-[132px] mb-96'>
    ...
    <div className='mt-[100px]'>
        <div className='block md:flex gap-20 items-center justify-center mb-10'>
            <div className='bg-white h-full w-full md:h-[383.51px] md:w-[353px] text-center pb-10'>
            ...
            <div className='bg-[#EBB40A26] h-full w-full md:h-[383.51px] md:w-[353px] text-center pb-10 md:mt-0 mt-10'>
